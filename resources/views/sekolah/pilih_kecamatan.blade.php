...
<head>
    ...
    <title>Pilih Kecamatan untuk {{ $bentuk_pendidikan }}</title>
    <style>
        table {
            width: 100%;
    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Pilih Kecamatan untuk
                    {{ $bentuk_pendidikan }}</h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 bg-white border border-gray-200 shadow-lg">
                            ...
                            @foreach ($kecamatan as $index => $kc)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-600">
                                        <a href="{{ route('filter.sekolah') }}"
                                            onclick="event.preventDefault(); document.getElementById('kecamatanForm{{ $loop->index }}').submit();"
                                            class="hover:underline">
                                            {{ $kc->kecamatan }}
                                        </a>
                                        <form id="kecamatanForm{{ $loop->index }}"
                                            action="{{ route('filter.sekolah') }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            <input type="hidden" name="bentuk_pendidikan"
                                                value="{{ $bentuk_pendidikan }}">
                                            <input type="hidden" name="kecamatan" value="{{ $kc->kecamatan }}">
                                        </form>
                                    </td>
